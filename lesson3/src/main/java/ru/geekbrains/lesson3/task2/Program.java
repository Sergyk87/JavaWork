...
public class Program {
    ...
    static Employee generateEmployee() {
        ...
        if (random.nextInt(0, 2) == 0) {
            ...
            return new Worker(names[random.nextInt(names.length)], surnames[random.nextInt(10)], age, salary);
        } else {
            int salary = random.nextInt(500, 1000);
            return new Freelancer(names[random.nextInt(names.length)], surnames[random.nextInt(10)], age, salary);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        // Arrays.sort(employees, new SortNameSurname());
        Arrays.sort(employees, new SortAgeSalary());
